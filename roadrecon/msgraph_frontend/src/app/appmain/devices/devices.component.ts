...
import { DatabaseService, DevicesItem } from '../msgraphobjects.service'
// import
@Component({
...
export class DevicesComponent implements AfterViewInit, OnInit {
  ...
  displayedColumns = ['displayName', 'manufacturer', 'accountEnabled', 'model', 'operatingSystem', 'operatingSystemVersion', 'trustType', 'isCompliant', 'isManaged', 'isRooted'];
