...
import { DevicesItem } from '../../msgraphobjects.service'
...
export class DevicesdialogComponent {
  ...
  public displayedColumnsDevices: string[] = ['displayName', 'manufacturer', 'accountEnabled', 'model', 'operatingSystem', 'operatingSystemVersion', 'trustType', 'isCompliant', 'isManaged', 'isRooted'];
