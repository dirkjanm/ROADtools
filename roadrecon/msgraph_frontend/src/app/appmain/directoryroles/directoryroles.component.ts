...
import { DatabaseService, RoleDefinitionsItem, UsersItem } from '../msgraphobjects.service'
// import
@Component({
...
export class DirectoryRolesComponent implements OnInit {
  ...
  displayedColumns = ['displayName', 'name', 'mail', 'department', 'lastPasswordChangeDateTime', 'jobTitle', 'mobile','objtype'];
