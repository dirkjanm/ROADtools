...
import { AdministrativeUnitsItem } from '../../msgraphobjects.service'
...
export class AdministrativeUnitsdialogComponent {
  ...
  public displayedColumnsUsers: string[] = ['displayName', 'description']
  ...
  public displayedColumnsDevices: string[] = ['displayName', 'model', 'operatingSystem', 'trustType'];
