...
import { DatabaseService, TenantDetail, DirectorySetting, TenantStats, AuthorizationPolicy } from '../msgraphobjects.service'
...
export class IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //     // permissionGrantPolicyIdsAssignedToDefaultUserRole - does not exist in AuthorizationPolicy any,ore
