...
import { DatabaseService, ApplicationsItem } from '../msgraphobjects.service'
// import
@Component({
...
export class ApplicationsComponent implements AfterViewInit, OnInit {
  ...
  displayedColumns = ['displayName', 'publicClient', 'passwordCredentials', 'keyCredentials', 'appRoles', 'ownerUsers'];
