...
import { UsersResolveService, GroupsResolveService, AdministrativeUnitsResolveService, ServicePrincipalsResolveService, DevicesResolveService, ApplicationsResolveService, ServicePrincipalsByAppIdResolveService } from './msgraphobjects.service'
