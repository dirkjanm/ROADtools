...
import { DatabaseService, OAuth2PermissionsItem } from '../msgraphobjects.service'
// import
@Component({
  selector: 'app-roles',
...
export class Oauth2permissionsComponent implements AfterViewInit, OnInit {
  ...
  // displayedColumns = ['clientId', 'resourceId', 'scope', 'principalId'];

  displayedColumns = ['type', 'userdisplayname', 'sourceapplication', 'targetapplication', 'scope'];
