...
import { DatabaseService, ServicePrincipalsItem } from '../msgraphobjects.service'
// import
@Component({
...
export class ServicePrincipalsComponent implements AfterViewInit, OnInit {
  ...
  // displayedColumns = ['displayName', 'description','servicePrincipalType', 'passwordCredentials', 'keyCredentials', 'appRoles', 'oauth2Permissions', 'owner'];
  displayedColumns = ['displayName', 'appRoleAssignmentRequired', 'appId', 'appOwnerOrganizationId', 'replyUrls', 'appRoles', 'oauth2PermissionScopes', 'passwordCredentials', 'keyCredentials', 'ownerUsers', 'accountEnabled', 'servicePrincipalType']
