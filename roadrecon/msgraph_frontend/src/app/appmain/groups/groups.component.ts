...
import { DatabaseService, GroupsItem } from '../msgraphobjects.service'
// import
@Component({
  selector: 'app-groups',
...
export class GroupsComponent implements AfterViewInit, OnInit {
  ...
  displayedColumns = ['displayName', 'description', 'groupTypes', 'onPremisesSyncEnabled', 'mail', 'isPublic', 'isAssignableToRole', 'membershipRule'];
