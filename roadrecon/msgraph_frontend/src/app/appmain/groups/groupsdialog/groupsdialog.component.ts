...
import { GroupsItem } from '../../msgraphobjects.service'
...
export class GroupsdialogComponent {
  ...
  public displayedColumnsUsers: string[] = ['displayName', 'userPrincipalName']
  ...
  public displayedColumnsDevices: string[] = ['displayName', 'model', 'operatingSystem', 'deviceTrustType'];
