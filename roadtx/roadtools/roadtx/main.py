...
def main():
    ...
    parser.add_argument('-a', '--authority', action='store', help="Custom authority to use for national clouds (format: auth URI without https:// prefix or alias: global / us / china. default: login.microsoftonline.com)")
